        ...
        <div className="px-2 py-4 border-b-2 border-gray-300 flex flex-wrap md:flex-nowrap ">
            ...
            <div className="my-2">
                ...
                <h3 className="tracking-widest text-gray-500 text-xs font-medium title-font">
                    <span className="inline-block p-1  mr-1 my-1 rounded-md bg-gray-100 font-medium tracking-widest">{data.level}</span>
                    <span className="inline-block p-1  mr-1 my-1 rounded-md bg-gray-100 font-medium tracking-widest">{data.category}</span>
                </h3>
            </div>
            </div>
        </div>
